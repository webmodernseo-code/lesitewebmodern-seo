...
const generateMockContent = (type: ContentType, title: string, focusKeyword: string) => {
  if (type === 'blog') {
    return `
      <h2 style="color:#0A0A0A; border-bottom:2px solid #F97316; padding-bottom:8px; margin-top:24px; font-weight:700;">H2 orange</h2>
      <p style="margin:16px 0; line-height:1.7; color:#0A0A0A;">Découvrez comment optimiser votre référencement grâce à nos conseils d'experts. Le mot-clé <strong>${focusKeyword || 'stratégie SEO'}</strong> doit être intégré de manière fluide dans vos paragraphes pour maximiser la pertinence.</p>
      ...
      <p style="margin:16px 0; line-height:1.7; color:#0A0A0A;">Assurez-vous de structurer votre contenu avec des titres clairs et d'insérer des liens internes pertinents pour guider vos lecteurs.</p>
      
      <a href="#" style="display:inline-block; background:#F97316; color:#FFFFFF; padding:14px 28px; border-radius:8px; font-weight:600; text-decoration:none; margin:16px 0;">CTA</a>
    `;
  } else {
