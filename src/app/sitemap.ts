...
const STATIC_ROUTES: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE_URL}/lyon`, lastModified: LAST_UPDATED, changeFrequency: 'monthly', priority: 0.8 },
  { url: `${BASE_URL}/grenoble`, lastModified: LAST_UPDATED, changeFrequency: 'monthly', priority: 0.8 },
  { url: `${BASE_URL}/paris`, lastModified: LAST_UPDATED, changeFrequency: 'monthly', priority: 0.8 },
  { url: `${BASE_URL}/saint-etienne`, lastModified: LAST_UPDATED, changeFrequency: 'monthly', priority: 0.8 },
